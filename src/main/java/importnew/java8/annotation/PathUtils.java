...
public class PathUtils {
	...
	public static String packageToPath(String packageName) {
		if (packageName == null || "".equals(packageName)) return packageName;
	...
	/**
	 * Return main path of the url. Example: "file:/com/example/hello" to
	 * "/com/example/hello" "jar:file:/com/example/hello.jar!/" to
